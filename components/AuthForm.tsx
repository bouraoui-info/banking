...
const AuthForm = ({ type }: { type: string }) => {
  ...
  return (
    <section className="auto-form">
      <header className="flex flex-col grap-5 md:gap-8 ">
              ...
              {type === "sign-up" && (
                <>
                  ...
                  <CustomInput
                    ...
                    name="address1"
                    label="Address"
                    palceholder="Enter your specific adress"
                  />
                  <CustomInput
                    control={form.control}
                    name="city"
                  ...
                  <div className="flex gap-4">
                    <CustomInput
                      ...
                      name="state"
                      label="State"
                      palceholder="Example: Regeba city "
                    />
                    <CustomInput
                      control={form.control}
                      name="postalCode"
                      label="Postal Code"
                      palceholder="Example: 2046 "
                    />
                  </div>
                  <div className="flex gap-4">
                    <CustomInput
                      ...
                      name="dateOfBirth"
                      label="Date of Birth"
                      palceholder="Example: YYYY-MM-DD "
                    />
                    <CustomInput
                      control={form.control}
                      name="ssn"
                      label="SSN"
                      palceholder="Example: 1234 "
                    />
                  </div>
                </>
              )}
